!(function () {
  ...
  (function () {
    ...
    for (
      var notes = {
          "1c": new Howl({ src: ["../library/piano/note/1.mp3"] }),
          "1cis": new Howl({ src: ["../library/piano/note/2.mp3"] }),
          "1d": new Howl({ src: ["../library/piano/note/3.mp3"] }),
          "1dis": new Howl({ src: ["../library/piano/note/4.mp3"] }),
          "1e": new Howl({ src: ["../library/piano/note/5.mp3"] }),
          "1f": new Howl({ src: ["../library/piano/note/6.mp3"] }),
          "1fis": new Howl({ src: ["../library/piano/note/7.mp3"] }),
          "1g": new Howl({ src: ["../library/piano/note/8.mp3"] }),
          "1gis": new Howl({ src: ["../library/piano/note/9.mp3"] }),
          "2a": new Howl({ src: ["../library/piano/note/10.mp3"] }),
          "2ais": new Howl({ src: ["../library/piano/note/11.mp3"] }),
          "2b": new Howl({ src: ["../library/piano/note/12.mp3"] }),
          "2c": new Howl({ src: ["../library/piano/note/13.mp3"] }),
          "2cis": new Howl({ src: ["../library/piano/note/14.mp3"] }),
          "2d": new Howl({ src: ["../library/piano/note/15.mp3"] }),
          "2dis": new Howl({ src: ["../library/piano/note/16.mp3"] }),
          "2e": new Howl({ src: ["../library/piano/note/17.mp3"] }),
          "2f": new Howl({ src: ["../library/piano/note/18.mp3"] }),
          "2fis": new Howl({ src: ["../library/piano/note/19.mp3"] }),
          "2g": new Howl({ src: ["../library/piano/note/20.mp3"] }),
          "2gis": new Howl({ src: ["../library/piano/note/21.mp3"] }),
          "3a": new Howl({ src: ["../library/piano/note/22.mp3"] }),
          "3ais": new Howl({ src: ["../library/piano/note/23.mp3"] }),
          "3b": new Howl({ src: ["../library/piano/note/24.mp3"] }),
          "3c": new Howl({ src: ["../library/piano/note/25.mp3"] }),
          "3cis": new Howl({ src: ["../library/piano/note/26.mp3"] }),
          "3d": new Howl({ src: ["../library/piano/note/27.mp3"] }),
          "3dis": new Howl({ src: ["../library/piano/note/28.mp3"] }),
          "3e": new Howl({ src: ["../library/piano/note/29.mp3"] }),
          "3f": new Howl({ src: ["../library/piano/note/30.mp3"] }),
          "3fis": new Howl({ src: ["../library/piano/note/31.mp3"] }),
          "3g": new Howl({ src: ["../library/piano/note/32.mp3"] }),
          "3gis": new Howl({ src: ["../library/piano/note/33.mp3"] }),
          "4a": new Howl({ src: ["../library/piano/note/34.mp3"] }),
          "4ais": new Howl({ src: ["../library/piano/note/35.mp3"] }),
          "4b": new Howl({ src: ["../library/piano/note/36.mp3"] }),
        },
        lockEvent = {},
        i = 0;
      256 > i;
