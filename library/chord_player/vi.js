window.translation = {
  ...
  button_names: {
    time_signature_text: "time",
    time_signature: ["3/4", "4/4", "5/4", "6/8"],
    style_text: "Thể loại",
    add_new_section: { add: "Thêm đoạn nhạc", remove: "Bỏ đoạn nhạc" },
    generate_chords_text: "Tạo các hợp âm",
    style_list: {
      pop1: "Pop 1",
      pop2: "Pop 2",
      pop3: "Pop 3",
  ...
  modal: {
    beats_text: { 1: "nhịp", 2: "nhịp", 3: "nhịp", 4: "nhịp" },
    ...
    root_dropdown: { C: "C", D: "D", E: "E", F: "F", G: "G", A: "A", B: "B" },
    accidentals: {
  ...
  saving_chord_progressions: {
    select_file_text: "Tệp tin",
    new: {
      new: "Mới",
      new_file: "Tệp tin mới",
      are_you_sure: "Bạn có chắc rằng mình muốn xóa bỏ các hợp âm này?",
      no: "Không",
      yes: "Có",
    },
    open: {
      open: "Mở",
      open_chords: "Mở các hợp âm",
      edit_chords: "Chỉnh sửa các hợp âm",
      name_exists: "Đã có một tệp tin mang tên này.",
    },
    save: {
      save: "Lưu",
      save_chords: "Lưu các hợp âm",
      file_exists:
        "Đã có một tệp tin mang tên này. Bạn có muốn ghi đè lên tệp tin ấy hay không?",
      create_account:
    ...
    share: {
      share: "Chia sẻ",
      share_chords: "Chia sẻ các hợp âm",
      copy_paste: "Sao chép và dán đường dẫn để chia sẻ các hợp âm của bạn.",
      link_copied: "Đường dẫn đã được sao chép",
      create_account:
        "Tạo một tài khoản miễn phí hay đăng nhập để chia sẻ các hợp âm của bạn.",
    },
  },
};
